export default function NextTrackIcon({stroke = '#fff', strokeRate = 1, width = null, height = null}) {
    return (
        <svg
        ...
        >
            <path
                ...
                transform="matrix(.19696 0 0 .19696 9.021 6.789)"
            />
            <path
                ...
                transform="translate(2.235 3.86) scale(.21984)"
            />
        </svg>
    )
}